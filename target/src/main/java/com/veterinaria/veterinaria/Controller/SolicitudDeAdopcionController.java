...
public class SolicitudDeAdopcionController {
    ...
    @PostMapping("/create")
    public ResponseEntity<SolicitudDeAdopcionResponses> crearSolicitud(@RequestBody SolicitudDeAdopcionRequest solicitudDeAdopcionRequest) {
        SolicitudDeAdopcionResponses solicitudDeAdopcion = solicitudDeAdopcionMapper.toEntity(solicitudDeAdopcionRequest);
        SolicitudDeAdopcion savedSolicitud = solicitudDeAdopcionService.save(solicitudDeAdopcionRequest);
        SolicitudDeAdopcionResponses response = solicitudDeAdopcionMapper.toResponse(savedSolicitud);
